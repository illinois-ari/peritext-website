...
export interface PageSetting {
   ...
   */
  page: 'home' | 'about' | 'contact' | 'team' | 'blog' | 'data';
  /**
   * Title of the page.
   */
  title: string;
...
export interface Team {
  id: number;
  /**
   * Determines the order of teams. Lower numbers appear first.
   */
  sortOrder: number;
  title: string;
  members: {
    /**
     * Determines the order of members within this team.
     */
    sortOrder: number;
    name: string;
    /**
     * Upload an image for the team member.
     */
    image: number | Media;
    /**
     * Add a bio for the team member.
     */
    description: {
      root: {
        type: string;
    ...
    /**
     * Link to the team member’s social profile (optional).
     */
    social?: string | null;
    id?: string | null;
  }[];
...
export interface About {
  ...
  order: number;
  /**
   * Choose "Text" for paragraphs or "Image" to display an image.
   */
  type: 'text' | 'image';
  /**
   * Only applicable for text sections.
   */
  content?: {
    root: {
      type: string;
  ...
  image?: {
    ...
    alt?: string | null;
    /**
     * Choose how the image is aligned on the page.
     */
    align: 'left' | 'right';
  };
  updatedAt: string;
